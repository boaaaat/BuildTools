...
public final class MaterialChecklistScreen extends AbstractContainerScreen<MaterialChecklistMenu> {
    ...
    public MaterialChecklistScreen(MaterialChecklistMenu menu, Inventory playerInventory, Component title) {
