...
public final class UndoTokenItem extends BuildToolItem {
    public UndoTokenItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        ...
        if (player instanceof ServerPlayer serverPlayer) {
            if (BuildOperationEngine.undo(serverPlayer) && !serverPlayer.gameMode.isCreative()) {
